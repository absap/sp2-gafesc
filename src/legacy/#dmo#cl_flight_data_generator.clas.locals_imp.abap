...
CLASS lcl_flight_data_generator DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    INTERFACES: lif_data_generator.
    TYPES: tt_flights TYPE STANDARD TABLE OF /dmo/flight WITH KEY carrier_id connection_id flight_date.
    CLASS-METHODS: get_data
      RETURNING VALUE(rt_data) TYPE tt_flights.
*      EXPORTING et_data TYPE tt_flights,
*                   build_connection_generate_info
*                           RETURNING
*                             value(rt_data) TYPE /dmo/cl_flight_data_generator=>tt_connection_additional_info.
...
*  METHOD build_connection_generate_info.
*    rt_data = VALUE /dmo/cl_flight_data_generator=>tt_connection_additional_info(
*                        ( connection_id = 0002  distance = 13523 weekday = 4 )
*                        ( connection_id = 0005  distance = 10000 weekday = 5 )
*                        ( connection_id = 0006  distance = 10000 weekday = 3 )
*                        ( connection_id = 0015  distance = 13523 weekday = 3 )
*                        ( connection_id = 0017  distance =  4115 weekday = 3 )
*                        ( connection_id = 0064  distance =  4115 weekday = 5 )
*                        ( connection_id = 0106  distance =  6161 weekday = 1 )
*                        ( connection_id = 0158  distance =   896 weekday = 2 )
*                        ( connection_id = 0400  distance =  6162 weekday = 6 )
*                        ( connection_id = 0401  distance =  6162 weekday = 5 )
*                        ( connection_id = 0402  distance =  6162 weekday = 1 )
*                        ( connection_id = 0407  distance =  9100 weekday = 5 )
*                        ( connection_id = 0408  distance =  9100 weekday = 6 )
*                        ( connection_id = 0555  distance =  1352 weekday = 3 )
*                        ( connection_id = 0788  distance =  9808 weekday = 2 )
*                        ( connection_id = 0789  distance =  9808 weekday = 3 )
*                        ( connection_id = 0790  distance =  9648 weekday = 3 )
*                        ( connection_id = 0941  distance =  9096 weekday = 4 )
*                        ( connection_id = 0988  distance =  5000 weekday = 4 )
*                        ( connection_id = 1699  distance =  4115 weekday = 1 )
*                        ( connection_id = 1984  distance =  4115 weekday = 1 )
*                        ( connection_id = 2402  distance =   555 weekday = 6 )
*                        ( connection_id = 2407  distance =   555 weekday = 6 )
*                        ( connection_id = 3504  distance =  9096 weekday = 5 )
*                        ( connection_id = 3516  distance =  6162 weekday = 1 )
*                        ( connection_id = 3517  distance =  6162 weekday = 1 )
*                      ).
*  ENDMETHOD.
  ...
  METHOD build_connection_recurrency.
    ...
    DATA:
      flight_date_max TYPE sy-datum,
      flight_date_min TYPE sy-datum.
...
CLASS lcl_supplement_data_generator IMPLEMENTATION.
  ...
  METHOD get_data.
    ...
    rt_data = VALUE tt_supplement_complete(
      ...
      "! TODO Extras
*      ( supplement_id = 'EX-0001' price = '100.00'  currency_code = 'EUR' language_code =  'E'    description   =  'hotel reservation' )
*      ( supplement_id = 'EX-0002' price = '120.00'   currency_code = 'EUR' language_code =  'E'   description   =  'airport to hotel transfer')
*      ( supplement_id = 'EX-0003' price = '165.00'  currency_code = 'EUR' language_code =  'E'    description   =  'city round trip')
*      ( supplement_id = 'EX-0004' price = '175.00'  currency_code = 'EUR' language_code =  'E'    description   =  'city round trip with boat ride ' )
*      ( supplement_id = 'EX-0005' price = '180.00'   currency_code = 'EUR' language_code =  'E'   description   =  'car reservation' )
*      ( supplement_id = 'EX-0006' price = '185.00'   currency_code = 'EUR' language_code =  'E'   description  =   'car and hotel reservation' )
*      ( supplement_id = 'EX-0007' price = '190.00'  currency_code = 'EUR' language_code =  'E'    description   =  'hotel reservation with breakfast ' )
*      ( supplement_id = 'EX-0008' price = '150.00'  currency_code = 'EUR' language_code =  'E'    description   =  'hotel reservation with breakfast, round trip' )
*      ( supplement_id = 'EX-0009' price = '200.00'   currency_code = 'EUR' language_code =  'E'   description   =  'hotel reservation with breakfast, round trip with boat ride' )
    )  .
  ENDMETHOD.
...
CLASS lcl_travel_data_generator DEFINITION CREATE PRIVATE.
  ...
  PRIVATE SECTION.
    ...
    TYPES: tt_flight_sorted_seats TYPE SORTED TABLE OF /dmo/flight WITH NON-UNIQUE KEY seats_occupied,
           tt_flight_sorted_date  TYPE SORTED TABLE OF /dmo/flight WITH NON-UNIQUE KEY connection_id flight_date.
...
CLASS lcl_travel_data_generator IMPLEMENTATION.
  ...
  METHOD get_data.
    ...
    WHILE lt_bookings IS NOT INITIAL.
      ...
      cl_abap_tstmp=>td_add(
            EXPORTING
                date     = COND d( WHEN lv_datum > lt_bookings[ 1 ]-booking_date
                                     THEN lt_bookings[ 1 ]-booking_date
                                     ELSE lv_datum  )
                time     = CONV t( 0 )
                secs     = -86400 * 15
            IMPORTING
                res_date = DATA(lv_travel_create_date_dats) ). "! extract method
      ...
      APPEND VALUE ty_travel_complete(
          ...
          total_price   = lv_booking_fee + REDUCE /dmo/travel-total_price( INIT sum = 0
                                                        ...
                                                        ) "! TODO Dependency to Currency Code
          currency_code = lt_bookings[ 1 ]-currency_code "! rethink
          ...
          createdby     = gt_last_names[ go_ran_last_name->get_next( ) ]-last_name "! rethink
          createdat     = CONV timestampl( CONV string( lv_travel_create_date_dats ) * 1000000 + generate_random_time( ) )
          lastchangedby = gt_last_names[ go_ran_last_name->get_next( ) ]-last_name "! rethink
          lastchangedat = lastchangedat_stamp "CONV timestampl( ( CONV string( lv_travel_create_date_dats  + go_ran_travel_change_date->get_next( ) ) ) * 1000000  + generate_random_time( ) )
  ...
  METHOD build_booking.
    ...
    DO lv_trip_length TIMES.
      ...
      ASSIGN gt_flights_seats_decrease[ carrier_id    = ls_flight-carrier_id
                                        connection_id = ls_flight-connection_id
                                        flight_date   = ls_flight-flight_date  ]
             TO FIELD-SYMBOL(<flight>).
      ...
      DATA(lv_price) = /dmo/cl_flight_data_generator=>calculate_flight_price(
                                      ...
                                      iv_seats_occupied_percent = ( gt_flights_final[ carrier_id    = <flight>-carrier_id
  ...
  METHOD find_next_fitting_flight.
    "! TODO Try to find flight back to start.
    DATA(lt_flights_filtered) = FILTER lcl_flight_data_generator=>tt_flights(
                                         CONV tt_flight_sorted_seats( gt_flights_seats_decrease )
    ...
    IF is_flight_previous IS SUPPLIED.
      ...
      DATA(lt_flights_filtered2) = FILTER lcl_flight_data_generator=>tt_flights(
                                                   CONV tt_flight_sorted_date( lt_flights_filtered )
                                                   WHERE connection_id = lv_connection_id_new
                                                     AND flight_date >= is_flight_previous-flight_date "! Flight date + 1 day?
                                              ).
  ...
  METHOD calculate_booking_fee. "! rethink
